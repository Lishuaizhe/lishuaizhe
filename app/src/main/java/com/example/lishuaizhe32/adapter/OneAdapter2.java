...
public class OneAdapter2 extends RecyclerView.Adapter<OneAdapter2.ViewHolder> {
    ...
    public OneAdapter2(Context context, List<OneBean.ResultBean> list) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view =LayoutInflater.from(context).inflate(R.layout.onesize2,viewGroup,false);
